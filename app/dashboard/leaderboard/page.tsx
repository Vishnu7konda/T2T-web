    ...
    try {
      ...
      if (!response.ok) {
        ...
        const mockLeaderboard = [
          ...
          { rank: 4, id: "u-4", name: "swathi reddy", email: "swathireddy@example.com", points: 3900, level: "BRONZE", submissions: 65, avatar: "https://i.pravatar.cc/150?u=neha", joinedAt: new Date().toISOString() },
          { rank: 5, id: "u-5", name: "krishna patel", email: "krishnapatel@example.com", points: 2100, level: "BRONZE", submissions: 32, avatar: "https://i.pravatar.cc/150?u=suresh", joinedAt: new Date().toISOString() },
          {
            rank: 15,
