    ...
    try {
      ...
      if (!response.ok) {
        ...
        const mockLeaderboard = [
          ...
          { rank: 4, id: "u-4", name: "swathi reddy", email: "@example.com", points: 3900, level: "BRONZE", submissions: 65, avatar: "https://i.pravatar.cc/150?u=neha", joinedAt: new Date().toISOString() },
